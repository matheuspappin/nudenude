    ...
    <div className="w-full max-w-3xl mx-auto flex flex-col gap-8 mt-4 px-4 sm:px-0">
      ...
      <div className="bg-card border border-white/10 rounded-xl p-6 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-8 items-start sm:items-center mb-6">
          ...
          <div className="flex-1 w-full flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input type="text" defaultValue="Usuário VIP" className="h-11 px-4 rounded-lg bg-background border border-white/10 text-white focus:border-primary/50 focus:outline-none transition-colors" />
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 flex flex-col gap-1.5">
                <label className="text-sm font-medium text-zinc-400">@username</label>
                <input type="text" defaultValue="usuario_vip99" className="h-11 px-4 rounded-lg bg-background border border-white/10 text-white focus:border-primary/50 focus:outline-none transition-colors" />
              </div>
              
              <div className="flex-1 flex flex-col gap-1.5">
                <label className="text-sm font-medium text-zinc-400">Contact E-mail</label>
                <input type="email" defaultValue="usuario@abc.com" className="h-11 px-4 rounded-lg bg-background border border-white/10 text-white focus:border-primary/50 focus:outline-none transition-colors" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5 mb-8">
           ...
           <textarea className="h-24 p-4 rounded-lg bg-background border border-white/10 text-white focus:border-primary/50 focus:outline-none resize-none transition-colors" placeholder="Say something about yourself..."></textarea>
        </div>
        ...
        <div className="flex flex-col gap-4 mb-8 p-5 bg-background/50 rounded-xl border border-white/5">
           <label className="flex items-start gap-3 cursor-pointer group">
             <div className="relative flex items-center justify-center mt-0.5 shrink-0">
               <input type="checkbox" defaultChecked className="peer appearance-none w-5 h-5 border border-white/20 rounded bg-background checked:bg-primary checked:border-primary transition-colors cursor-pointer" />
        ...
        <div className="flex justify-end">
          <button className="h-11 px-8 rounded-lg bg-primary text-primary-foreground font-bold shadow-glow hover:bg-primary/90 hover:shadow-glow-lg transition-all">
            Save Changes
          </button>
        </div>
      </div>
